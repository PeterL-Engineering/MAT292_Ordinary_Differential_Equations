...
Key milestones from our detailed Gantt chart (\ref{app:a_gantt_chart}) ensure steady progress toward our objectives:
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.82\linewidth]{Figs/gantt_chart_rot.png}
