...
We outline the details of our primary method below (Euler's Method) and further details on the others can be found in \ref{app: appendix_b}.
...
Almost all numerical methods are in essence variations and improvements upon Euler's method.
In this section we outline the two other methods we intend to use: Improved Euler's Method and Runge-Kutta Method.
